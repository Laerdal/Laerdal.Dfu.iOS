...
usage(){
    echo "usage: ./build.local.sh [-r|--revision build_revision] [-c|--clean-output] [-v|--verbose] [-s|--sharpie]"
    echo "parameters:"
...
echo "xbuild_parameters = $xbuild_parameters"
echo

$xbuild ONLY_ACTIVE_ARCH=NO $xbuild_parameters -sdk iphoneos build
$xbuild ONLY_ACTIVE_ARCH=NO $xbuild_parameters -sdk iphonesimulator build
