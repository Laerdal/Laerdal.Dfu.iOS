...
interface LegacyDFUServiceInitiator
{
	...
	// -(instancetype _Nonnull)initWithCentralManager:(CBCentralManager * _Nonnull)centralManager target:(CBPeripheral * _Nonnull)target __attribute__((deprecated(""))) __attribute__((objc_designated_initializer));
	[Export ("initWithCentralManager:target:")]
	[DesignatedInitializer]
	IntPtr Constructor (CBCentralManager centralManager, CBPeripheral target);
